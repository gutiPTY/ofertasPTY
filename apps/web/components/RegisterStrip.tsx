    ...
    <div className="mt-8 bg-gradient-to-r from-ember to-flare text-white">
      <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-4 px-4 py-5 sm:px-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="font-display text-lg font-semibold">¿Todavía no tenés cuenta?</h2>
            <p className="text-sm opacity-90">
              Registrate gratis y elegí tus categorías favoritas para recibir un resumen semanal
              de ofertas nuevas.
            </p>
          </div>
        </div>
